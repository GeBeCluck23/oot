...
CollisionPoly escape_rm_exit_polygons[] = {
	...
	{ 0x0000, 0x0009, 0x000a, 0x0008, COLPOLY_SNORMAL(0.0), COLPOLY_SNORMAL(-0.9552135467529297), COLPOLY_SNORMAL(0.2959175705909729), 0x0085 },
	{ 0x0000, 0x000a, 0x000b, 0x0008, COLPOLY_SNORMAL(0.0), COLPOLY_SNORMAL(-0.9552135467529297), COLPOLY_SNORMAL(0.2959176003932953), 0x0085 },
	...
	{ 0x0000, 0x0012, 0x0008, 0x000b, COLPOLY_SNORMAL(0.0), COLPOLY_SNORMAL(-0.9632264375686646), COLPOLY_SNORMAL(-0.26869088411331177), 0x0437 },
	{ 0x0000, 0x0012, 0x0013, 0x0008, COLPOLY_SNORMAL(0.0), COLPOLY_SNORMAL(-0.9632264375686646), COLPOLY_SNORMAL(-0.26869088411331177), 0x0437 },
	{ 0x0000, 0x000a, 0x0014, 0x000b, COLPOLY_SNORMAL(-0.996361255645752), COLPOLY_SNORMAL(-6.434772714669634e-09), COLPOLY_SNORMAL(0.08523114770650864), 0x009d },
	{ 0x0000, 0x000d, 0x0014, 0x000a, COLPOLY_SNORMAL(-0.9963611960411072), COLPOLY_SNORMAL(-6.4347722705804244e-09), COLPOLY_SNORMAL(0.08523114025592804), 0x009d },
	{ 0x0000, 0x000e, 0x0009, 0x0008, COLPOLY_SNORMAL(0.9963611960411072), COLPOLY_SNORMAL(-6.4347722705804244e-09), COLPOLY_SNORMAL(0.08523114025592804), 0x009d },
	{ 0x0000, 0x000e, 0x0008, 0x0015, COLPOLY_SNORMAL(0.996361255645752), COLPOLY_SNORMAL(-6.434772714669634e-09), COLPOLY_SNORMAL(0.08523114770650864), 0x009d },
	{ 0x0000, 0x0016, 0x0014, 0x0017, COLPOLY_SNORMAL(0.0), COLPOLY_SNORMAL(0.9632264971733093), COLPOLY_SNORMAL(0.2686908543109894), 0xfce8 },
	{ 0x0000, 0x0018, 0x0017, 0x0015, COLPOLY_SNORMAL(0.0), COLPOLY_SNORMAL(0.9632264971733093), COLPOLY_SNORMAL(0.2686908543109894), 0xfce8 },
	{ 0x0000, 0x0018, 0x0016, 0x0017, COLPOLY_SNORMAL(0.0), COLPOLY_SNORMAL(0.9632264375686646), COLPOLY_SNORMAL(0.26869088411331177), 0xfce8 },
	...
	{ 0x0000, 0x000d, 0x0017, 0x0014, COLPOLY_SNORMAL(0.0), COLPOLY_SNORMAL(0.9717641472816467), COLPOLY_SNORMAL(-0.23595470190048218), 0x002f },
	{ 0x0000, 0x000d, 0x000c, 0x0017, COLPOLY_SNORMAL(0.0), COLPOLY_SNORMAL(0.9717641472816467), COLPOLY_SNORMAL(-0.2359546720981598), 0x002f },
	{ 0x0000, 0x000e, 0x0015, 0x0017, COLPOLY_SNORMAL(0.0), COLPOLY_SNORMAL(0.9717641472816467), COLPOLY_SNORMAL(-0.2359546720981598), 0x002f },
	{ 0x0000, 0x000c, 0x000f, 0x0017, COLPOLY_SNORMAL(0.0), COLPOLY_SNORMAL(0.971764087677002), COLPOLY_SNORMAL(-0.2359546422958374), 0x002f },
	{ 0x0000, 0x000f, 0x000e, 0x0017, COLPOLY_SNORMAL(0.0), COLPOLY_SNORMAL(0.9717641472816467), COLPOLY_SNORMAL(-0.2359546720981598), 0x002f },
	{ 0x0001, 0x001f, 0x001d, 0x001e, COLPOLY_SNORMAL(0.0), COLPOLY_SNORMAL(0.9737902283668518), COLPOLY_SNORMAL(-0.22744803130626678), 0x001d },
	{ 0x0001, 0x001f, 0x0020, 0x0021, COLPOLY_SNORMAL(0.0), COLPOLY_SNORMAL(0.9737902283668518), COLPOLY_SNORMAL(-0.22744804620742798), 0x001d },
	{ 0x0001, 0x001f, 0x0021, 0x001d, COLPOLY_SNORMAL(0.0), COLPOLY_SNORMAL(0.9737902283668518), COLPOLY_SNORMAL(-0.22744804620742798), 0x001d },
};
